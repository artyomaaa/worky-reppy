...
class MailResetPasswordNotification extends ResetPassword implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        if (static::$createUrlCallback) {
            ...
            $url = env('APP_FRONTEND_URL') . '/password/reset?token=' . $this->token . '&email=' . $notifiable->getEmailForPasswordReset();
...
//            ], false));
        ...
        $url = str_replace(env('APP_URL') . '/api', env('APP_FRONTEND_URL'), $url);
